...
public class PortalTableBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:portal_table")
	public static final Block block = null;
	@ObjectHolder("shinycreepers_end_update:portal_table")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public PortalTableBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 19);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("portal_table"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("portal_table");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Portal Table");
		}
