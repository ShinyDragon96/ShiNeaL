...
public class PortalTableBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return new TextComponent("portal_table");
	}
	...
	public Component getDisplayName() {
		return new TextComponent("Portal Table");
	}
