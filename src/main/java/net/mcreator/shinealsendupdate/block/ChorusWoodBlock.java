...
public class ChorusWoodBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:chorus_wood")
	public static final Block block = null;

	public ChorusWoodBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 53);
	}
