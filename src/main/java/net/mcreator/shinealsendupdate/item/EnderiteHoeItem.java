...
public class EnderiteHoeItem extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:enderite_hoe")
	public static final Item block = null;

	public EnderiteHoeItem(ShinealsEndUpdateModElements instance) {
		super(instance, 34);
	}
