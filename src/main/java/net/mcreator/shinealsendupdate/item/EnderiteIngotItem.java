...
public class EnderiteIngotItem extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:enderite_ingot")
	public static final Item block = null;

	public EnderiteIngotItem(ShinealsEndUpdateModElements instance) {
		super(instance, 6);
	}
