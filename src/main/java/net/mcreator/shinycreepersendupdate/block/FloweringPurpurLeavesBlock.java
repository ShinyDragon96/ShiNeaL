...
public class FloweringPurpurLeavesBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:flowering_purpur_leaves")
	public static final Block block = null;

	public FloweringPurpurLeavesBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 59);
	}
