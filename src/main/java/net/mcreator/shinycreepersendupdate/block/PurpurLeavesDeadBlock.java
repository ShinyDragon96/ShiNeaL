...
public class PurpurLeavesDeadBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:purpur_leaves_dead")
	public static final Block block = null;

	public PurpurLeavesDeadBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purpur_leaves_dead");
		}
