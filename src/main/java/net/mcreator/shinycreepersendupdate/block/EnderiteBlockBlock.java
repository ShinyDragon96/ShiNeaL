...
public class EnderiteBlockBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:enderite_block")
	public static final Block block = null;

	public EnderiteBlockBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 16);
	}
