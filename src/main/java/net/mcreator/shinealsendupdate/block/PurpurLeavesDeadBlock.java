...
public class PurpurLeavesDeadBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:purpur_leaves_dead")
	public static final Block block = null;

	public PurpurLeavesDeadBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 57);
	}
