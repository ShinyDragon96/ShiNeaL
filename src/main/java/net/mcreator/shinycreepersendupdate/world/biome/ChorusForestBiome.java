...
package net.mcreator.shinycreepersendupdate.world.biome;
...
import net.mcreator.shinycreepersendupdate.block.ChorusPlanksBlock;
import net.mcreator.shinycreepersendupdate.block.ChorusLogBlock;
...
public class ChorusForestBiome extends ShinycreepersEndUpdateModElements.ModElement {
	public static Biome biome;

	public ChorusForestBiome(ShinycreepersEndUpdateModElements instance) {
		super(instance, 25);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-5999965).setWaterFogColor(-5999965)
						.withSkyColor(7972607).withFoliageColor(-5999965).withGrassColor(-5999965).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ChorusPlanksBlock.block.getDefaultState(),
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(ChorusLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(ChorusLogBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("shinycreepers_end_update:chorus_forest"));
			}
		}
	}
