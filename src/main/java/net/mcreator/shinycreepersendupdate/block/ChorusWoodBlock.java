...
public class ChorusWoodBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:chorus_wood")
	public static final Block block = null;

	public ChorusWoodBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 53);
	}
