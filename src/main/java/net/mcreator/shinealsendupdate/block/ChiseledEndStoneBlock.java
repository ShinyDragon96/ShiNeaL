...
public class ChiseledEndStoneBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:chiseled_end_stone")
	public static final Block block = null;

	public ChiseledEndStoneBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 15);
	}
