...
public class EnderiteAxeItem extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:enderite_axe")
	public static final Item block = null;

	public EnderiteAxeItem(ShinealsEndUpdateModElements instance) {
		super(instance, 32);
	}
