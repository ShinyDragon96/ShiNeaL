...
public class PortalTableBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:portal_table")
	public static final Block block = null;
	@ObjectHolder("shineals_end_update:portal_table")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public PortalTableBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 19);
