...
public class ChorusLogBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:chorus_log")
	public static final Block block = null;

	public ChorusLogBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 22);
	}
