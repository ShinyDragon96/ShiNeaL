...
public class EndMageRenderer extends GeoEntityRenderer<EndMageEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, EndMageEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
