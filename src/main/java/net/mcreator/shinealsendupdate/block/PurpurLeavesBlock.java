...
public class PurpurLeavesBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:purpur_leaves")
	public static final Block block = null;

	public PurpurLeavesBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 58);
	}
