...
public class EnderiteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("shineals_end_update:enderite_ore", FEATURE,
				new OreConfiguration(EnderiteOreFeatureRuleTest.INSTANCE, ShinealsEndUpdateModBlocks.ENDERITE_ORE.get().defaultBlockState(), 2));
		PLACED_FEATURE = PlacementUtils.register("shineals_end_update:enderite_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(1), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(70))));
		return FEATURE;
	}
	...
	private static class EnderiteOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("shineals_end_update:enderite_ore_match"), CUSTOM_MATCH);
		}
