...
import net.mcreator.shinycreepersendupdate.item.EnderiteArmorItem;
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ShinycreepersEndUpdateMod.LOGGER.warn("Failed to load dependency entity for procedure CoverMeInShardsProcedure!");
			return;
		}
					...
					if ((entity instanceof PlayerEntity)
						...
						if (entity instanceof ServerPlayerEntity) {
							Advancement _adv = ((MinecraftServer) ((ServerPlayerEntity) entity).server).getAdvancementManager()
									.getAdvancement(new ResourceLocation("shinycreepers_end_update:cover_me_in_shards"));
