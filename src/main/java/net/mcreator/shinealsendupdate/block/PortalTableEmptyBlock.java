...
import net.mcreator.shinealsendupdate.procedures.PortalTableEmptyOnBlockRightClickedProcedure;
...
public class PortalTableEmptyBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:portal_table_empty")
	public static final Block block = null;

	public PortalTableEmptyBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			PortalTableEmptyOnBlockRightClickedProcedure.executeProcedure(Stream
