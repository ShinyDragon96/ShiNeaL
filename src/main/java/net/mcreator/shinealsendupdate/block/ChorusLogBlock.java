...
public class ChorusLogBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:chorus_log")
	public static final Block block = null;

	public ChorusLogBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 22);
	}
