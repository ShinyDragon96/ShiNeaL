...
public class ShinealsEndUpdateModItems {
	...
	public static final RegistryObject<Item> FLOWERING_PURPUR_LEAVES = block(ShinealsEndUpdateModBlocks.FLOWERING_PURPUR_LEAVES,
			ShinealsEndUpdateModTabs.TAB_SHINY_CREEPERS_END_UPDATE);
	public static final RegistryObject<Item> END_STRIDER = REGISTRY.register("end_strider_spawn_egg",
			() -> new ForgeSpawnEggItem(ShinealsEndUpdateModEntities.END_STRIDER, -10092442, -16751104,
