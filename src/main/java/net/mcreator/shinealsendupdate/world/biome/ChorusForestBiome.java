...
public class ChorusForestBiome extends ShinealsEndUpdateModElements.ModElement {
	public static Biome biome;

	public ChorusForestBiome(ShinealsEndUpdateModElements instance) {
		super(instance, 25);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("shineals_end_update:chorus_forest"));
			}
		}
	}
