...
public class ChiseledEndStoneBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:chiseled_end_stone")
	public static final Block block = null;

	public ChiseledEndStoneBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 15);
	}
