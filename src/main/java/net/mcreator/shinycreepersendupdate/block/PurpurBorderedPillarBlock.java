...
public class PurpurBorderedPillarBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:purpur_bordered_pillar")
	public static final Block block = null;

	public PurpurBorderedPillarBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3.5f, 10f).setLightLevel(s -> 0));
