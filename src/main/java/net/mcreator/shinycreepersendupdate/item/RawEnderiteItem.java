...
public class RawEnderiteItem extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:raw_enderite")
	public static final Item block = null;

	public RawEnderiteItem(ShinycreepersEndUpdateModElements instance) {
		super(instance, 5);
	}
