...
import net.mcreator.shinycreepersendupdate.procedures.PortalTableEmptyOnBlockRightClickedProcedure;
...
public class PortalTableEmptyBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:portal_table_empty")
	public static final Block block = null;

	public PortalTableEmptyBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 20);
	}
