...
public class EndStonePillarBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:end_stone_pillar")
	public static final Block block = null;

	public EndStonePillarBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 1);
	}
