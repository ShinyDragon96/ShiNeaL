...
public class ChorusPlanksBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:chorus_planks")
	public static final Block block = null;

	public ChorusPlanksBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 23);
	}
