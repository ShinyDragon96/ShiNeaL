...
public class EndStriderEntity extends PathfinderMob implements GeoEntity {
	...
	public EndStriderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ShinealsEndergrowthModEntities.END_STRIDER.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "end_strider");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, EnderPhantomEntity.class, (float) 6, 1, 1.2));
	...
	public static void init() {
		SpawnPlacements.register(ShinealsEndergrowthModEntities.END_STRIDER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
