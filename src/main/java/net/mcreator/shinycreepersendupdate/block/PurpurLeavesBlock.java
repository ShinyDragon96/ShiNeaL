...
public class PurpurLeavesBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:purpur_leaves")
	public static final Block block = null;

	public PurpurLeavesBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 58);
	}
