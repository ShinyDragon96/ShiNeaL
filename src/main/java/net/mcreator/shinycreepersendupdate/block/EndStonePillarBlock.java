...
public class EndStonePillarBlock extends ShinycreepersEndUpdateModElements.ModElement {
	@ObjectHolder("shinycreepers_end_update:end_stone_pillar")
	public static final Block block = null;

	public EndStonePillarBlock(ShinycreepersEndUpdateModElements instance) {
		super(instance, 1);
	}
