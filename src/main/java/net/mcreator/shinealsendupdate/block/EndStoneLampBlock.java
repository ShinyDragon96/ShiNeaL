...
public class EndStoneLampBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:end_stone_lamp")
	public static final Block block = null;

	public EndStoneLampBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 11);
	}
