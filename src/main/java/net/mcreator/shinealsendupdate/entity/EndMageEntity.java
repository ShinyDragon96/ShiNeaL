...
public class EndMageEntity extends EnderMan implements RangedAttackMob, GeoEntity {
	...
	public EndMageEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ShinealsEndUpdateModEntities.ENDMAGE.get(), world);
	}

	public EndMageEntity(EntityType<EndMageEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "enderman");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new EndMageEntity.RangedAttackGoal(this, 1.25, 20, 10f) {
			@Override
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((EndMageEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((EndMageEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		EndMageEntityProjectile entityarrow = new EndMageEntityProjectile(ShinealsEndUpdateModEntities.ENDMAGE_PROJECTILE.get(), this, this.level);
	...
	public static void init() {
		SpawnPlacements.register(ShinealsEndUpdateModEntities.ENDMAGE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(EndMageEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
