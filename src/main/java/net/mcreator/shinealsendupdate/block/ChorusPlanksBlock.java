...
public class ChorusPlanksBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:chorus_planks")
	public static final Block block = null;

	public ChorusPlanksBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 23);
	}
