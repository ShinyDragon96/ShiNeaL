...
public class SmoothEndStoneBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:smooth_end_stone")
	public static final Block block = null;

	public SmoothEndStoneBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 3);
	}
