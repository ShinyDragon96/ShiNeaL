...
public class RawEnderiteBlockBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:enderite_crystal_block")
	public static final Block block = null;

	public RawEnderiteBlockBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 12);
	}
