...
public class PurpurBorderedPillarBlock extends ShinealsEndUpdateModElements.ModElement {
	@ObjectHolder("shineals_end_update:purpur_bordered_pillar")
	public static final Block block = null;

	public PurpurBorderedPillarBlock(ShinealsEndUpdateModElements instance) {
		super(instance, 45);
	}
